    ...
    <div className="bg-gray-900 text-white min-h-screen flex flex-col items-center">
      ...
      <header className="flex flex-col md:flex-row items-center justify-between mt-10 animate__animated animate__fadeIn">
        <div className="md:w-1/3 flex justify-center mb-8 md:mb-0">
          <img
            ...
            alt="Smart Bin"
            className="w-48 h-48 md:w-64 md:h-64 rounded-full shadow-lg transform transition-transform duration-500 hover:scale-110 hover:rotate-6"
          />
        </div>
        <div className="md:w-2/3 text-center md:text-left">
          <h1 className="text-5xl font-extrabold leading-tight mb-4 animate__animated animate__fadeIn animate__delay-1s text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500">
          ...
          <ul className="list-disc list-inside mt-4 text-gray-300 animate__animated animate__fadeIn animate__delay-4s space-y-2">
            ...
            <li className="hover:text-green-500 transition duration-300">
              Real-time map for monitoring waste collection
            </li>
            <li className="hover:text-green-500 transition duration-300">
              Cloud-based analytics for data-driven decisions
            </li>
            <li className="hover:text-green-500 transition duration-300">
      ...
      <section className="mt-24 w-full px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h2
            className="text-4xl font-bold mb-8 animate__animated animate__fadeIn text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500"
            data-aos="fade-up"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div
              className="bg-blue-900 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate__animated animate__fadeInLeft"
              data-aos="fade-right"
              data-aos-duration="1000"
            >
            ...
            <div
              className="bg-green-700 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate__animated animate__fadeInRight"
              data-aos="fade-left"
              data-aos-duration="1000"
            >
      ...
      <section className="mt-24 w-full px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div
              className="bg-gradient-to-r from-orange-500 to-white p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate__animated animate__fadeInLeft"
              data-aos="fade-right"
              data-aos-duration="1000"
            >
            ...
            <div
              className="bg-gradient-to-r from-green-500 to-lime-400 p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 animate__animated animate__fadeInRight"
              data-aos="fade-left"
              data-aos-duration="1000"
            >
              <h3 className="text-2xl font-semibold mb-2 text-green-300">
